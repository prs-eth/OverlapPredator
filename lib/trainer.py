...
class Trainer(object):
    ...
    def inference_one_epoch(self, epoch, phase):
        ...
        for c_iter in tqdm(range(num_iter)):  # loop through this epoch
            try:
                ...
                # Handle the case where the data loader iterator is exhausted.
                break
    ...
    def train(self):
        ...
        # finish all epoch
            ...
            # Here you can add any additional logging or cleanup if necessary.
        finally:
            print("Cleaning up resources...")
            # Perform any final cleanup here, such as closing files or releasing CUDA memory.
